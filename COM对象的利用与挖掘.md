...
![InProcServer32](https://gitee.com/tianxuan-securitylab/source/raw/master/img/InProcServer32.png)
...
![运行VBS](https://gitee.com/tianxuan-securitylab/source/raw/master/img/运行VBS.png)
...
![改造EXP](https://gitee.com/tianxuan-securitylab/source/raw/master/img/改造EXP.png)
...
![宏安全提示](https://gitee.com/tianxuan-securitylab/source/raw/master/img/宏安全提示.png)

点击启用宏后，使用cmd起计算器：

![word起calc](https://gitee.com/tianxuan-securitylab/source/raw/master/img/word起calc.png)
...
![word起calc](https://gitee.com/tianxuan-securitylab/source/raw/master/img/image-20210630154827820.png)
...
![powershell创建COM](https://gitee.com/tianxuan-securitylab/source/raw/master/img/powershell创建COM.png)
...
![clsid](https://gitee.com/tianxuan-securitylab/source/raw/master/img/clsid.png)
...
![clsid-members](https://gitee.com/tianxuan-securitylab/source/raw/master/img/clsid-members.png)
...
![ExecuteExcel4Macro](https://gitee.com/tianxuan-securitylab/source/raw/master/img/ExecuteExcel4Macro.png)
...
![ExecuteExcel4Macro-calc](https://gitee.com/tianxuan-securitylab/source/raw/master/img/ExecuteExcel4Macro-calc.png)
...
![oleview](https://gitee.com/tianxuan-securitylab/source/raw/master/img/oleview.png)

但仅凭这些信息无法确定该方法是否能起任意进程，于是逆向查看LaunchSystemApplication，由于有调试符号，因此可以直接定位到该方法：

![LaunchSystemApplication](https://gitee.com/tianxuan-securitylab/source/raw/master/img/LaunchSystemApplication.png)

LaunchSystemApplication调用LaunchSystemApplicationInternal，进入查看发现调用了CreateProcess，有利用的可能：

![LaunchSystemApplicationInternal](https://gitee.com/tianxuan-securitylab/source/raw/master/img/LaunchSystemApplicationInternal.png)

但是可以看到调用了IsApprovedApplication方法进行校验，进入查看：

![IsApprovedApplication](https://gitee.com/tianxuan-securitylab/source/raw/master/img/IsApprovedApplication.png)

![ExeName](https://gitee.com/tianxuan-securitylab/source/raw/master/img/ExeName.png)
